...
public class MainWithGui extends JFrame {
    ...
    public static void updateExecution() {
        for (int i = 0; i < setOfInstructions.size(); i++) {
            if (setOfInstructions.get(i).inExecution) {
                if (setOfInstructions.get(i).endExec < MainWithGui.clk) {
    ...
    public static void initialize() {
        ...
        System.out.println(latencyMul);
        System.out.println(latencyAddD);
        System.out.println(latencyDAdd);
        System.out.println(latencyLoad);
        System.out.println(latencyStore);
        System.out.println(latencyAddi);
        System.out.println(latencySubi);
        System.out.println(latencyDiv);
        System.out.println(latencyBranch);
    ...
    public static void issue() {
        ...
        if (isIssued) {
            instruction.issue = MainWithGui.clk;
            for (int i = 0; i < fileOfRegisters.size(); i++) {
    ...
    public static void execute() {
            ...
            if (LoadStation[i].getBusy() == 1) {
                for (int j = 0; j < setOfInstructions.size(); j++) {
                    if (setOfInstructions.get(j).instructionId == LoadStation[i].getInstructionId()
                            ...
                            && setOfInstructions.get(j).issue != MainWithGui.clk
                            && setOfInstructions.get(j).endExec == -1) {
                        setOfInstructions.get(j).startExec = MainWithGui.clk;
                        setOfInstructions.get(j).endExec = MainWithGui.clk + latencyLoad - 1;
                ...
                for (int j = 0; j < setOfInstructions.size(); j++) {
                    if (setOfInstructions.get(j).instructionId == StoreStation[i].getInstructionId()) {
                        if (StoreStation[i].getQueue().equals("0") && !setOfInstructions.get(j).inExecution
                                ...
                                && setOfInstructions.get(j).endExec == -1) {
                            setOfInstructions.get(j).startExec = MainWithGui.clk;
                            setOfInstructions.get(j).endExec = MainWithGui.clk + latencyStore - 1;
                            setOfInstructions.get(j).inExecution = true;
                        }
                        break;
                    }
                    ...
                    if (AddStation[i].opcode.equals("ADD.D") || AddStation[i].opcode.equals("SUB.D")) {
                        ...
                        for (int j = 0; j < setOfInstructions.size(); j++) {
                            if (setOfInstructions.get(j).instructionId == AddStation[i].getInstructionId()
                                ...
                                setOfInstructions.get(j).startExec = MainWithGui.clk;
                                setOfInstructions.get(j).endExec = MainWithGui.clk + latencyAddD - 1;
                                setOfInstructions.get(j).inExecution = true;
                                break;
                            }
                        }
                        ...
                        for (int j = 0; j < setOfInstructions.size(); j++) {
                            if (setOfInstructions.get(j).instructionId == AddStation[i].getInstructionId()
                                ...
                                // setOfInstructions.get(j).result = result;
                                setOfInstructions.get(j).startExec = MainWithGui.clk;
                                setOfInstructions.get(j).endExec = MainWithGui.clk + latencyDAdd - 1;
                                setOfInstructions.get(j).inExecution = true;
                                break;
                            }
                        }
                        ...
                        for (int j = 0; j < setOfInstructions.size(); j++) {
                            if (setOfInstructions.get(j).instructionId == AddStation[i].getInstructionId()
                                ...
                                // setOfInstructions.get(j).result = result;
                                setOfInstructions.get(j).startExec = MainWithGui.clk;
                                setOfInstructions.get(j).endExec = MainWithGui.clk + latencyAddi - 1;
                                setOfInstructions.get(j).inExecution = true;
                                break;
                            }
                        }
                        ...
                        for (int j = 0; j < setOfInstructions.size(); j++) {
                            if (setOfInstructions.get(j).instructionId == AddStation[i].getInstructionId()
                                ...
                                // setOfInstructions.get(j).result = result;
                                setOfInstructions.get(j).startExec = MainWithGui.clk;
                                setOfInstructions.get(j).endExec = MainWithGui.clk + latencySubi - 1;
                                setOfInstructions.get(j).inExecution = true;
                                break;
                            }
                        }
                        ...
                        for (int j = 0; j < setOfInstructions.size(); j++) {
                            if (setOfInstructions.get(j).instructionId == AddStation[i].getInstructionId()
                                    ...
                                    && setOfInstructions.get(j).endExec == -1) {
                                setOfInstructions.get(j).startExec = MainWithGui.clk;
                                setOfInstructions.get(j).endExec = MainWithGui.clk + latencyBranch - 1;
                                setOfInstructions.get(j).inExecution = true;
                                break;
                            }
                        }
                    ...
                    if (MultiplyStation[i].opcode.equals("MUL.D")) {
                        ...
                        for (int j = 0; j < setOfInstructions.size(); j++) {
                            if (setOfInstructions.get(j).instructionId == MultiplyStation[i].getInstructionId()
                                ...
                                // setOfInstructions.get(j).result = result;
                                setOfInstructions.get(j).startExec = MainWithGui.clk;
                                setOfInstructions.get(j).endExec = MainWithGui.clk + latencyMul - 1;
                                setOfInstructions.get(j).inExecution = true;
                                break;
                            }
                        }
                        ...
                        for (int j = 0; j < setOfInstructions.size(); j++) {
                            if (setOfInstructions.get(j).instructionId == MultiplyStation[i].getInstructionId()
                                ...
                                // setOfInstructions.get(j).result = result;
                                setOfInstructions.get(j).startExec = MainWithGui.clk;
                                setOfInstructions.get(j).endExec = MainWithGui.clk + latencyDiv - 1;
                                setOfInstructions.get(j).inExecution = true;
                                break;
                            }
                        }
        ...
        for (int i = 0; i < setOfInstructions.size(); i++) {
            if (setOfInstructions.get(i).endExec == MainWithGui.clk && setOfInstructions.get(i).writeResultClock == -1
    ...
    public static void write() {
        ...
        for (int i = 0; i < setOfInstructions.size(); i++) {
            if (setOfInstructions.get(i).endExec < MainWithGui.clk && setOfInstructions.get(i).writeResultClock == -1
                ...
                setOfInstructions.get(i).writeResultClock = MainWithGui.clk;
    ...
    public static void main(String[] args) {
        try (Scanner sc = new Scanner(System.in)) {
            ...
            MainWithGui main = new MainWithGui();
            // printProcessorState();
        }
    }
    ...
    private void updateQueueTable() {
        ...
        Queue<Instruction> temp = new LinkedList<>(MainWithGui.queueInstructions);
    ...
    public void updateReservationAreaTables() {
        ...
        for (int i = 0; i < MainWithGui.MultiplyStation.length; i++) {
            addMulDivReservationArea(MainWithGui.MultiplyStation[i]);
        }
        for (int i = 0; i < MainWithGui.AddStation.length; i++) {
            addAddSubReservationArea(MainWithGui.AddStation[i]);
        }
        for (int i = 0; i < MainWithGui.LoadStation.length; i++) {
            addLoadBuffer(MainWithGui.LoadStation[i]);
        }
        for (int i = 0; i < MainWithGui.StoreStation.length; i++) {
            addStoreBuffer(MainWithGui.StoreStation[i]);
        }
    }
